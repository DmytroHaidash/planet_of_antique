        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios.post('/admin/media/upload', formData).then(function (_ref) {
                  var data = _ref.data;
...
module.exports = __webpack_require__(/*! C:\OSPanel\domains\Kosarev\planet_of_antiques\resources\js\admin\app.js */"./resources/js/admin/app.js");
