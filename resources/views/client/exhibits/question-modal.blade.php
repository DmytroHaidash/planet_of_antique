<div class="custom-modal-2" id="exhibitsQuestion">
    ...
    <h5 class="text-2xl text-center mb-5">{{ $exhibit->title }}</h5>
    <form action="{{ route('client.exhibits.question', $exhibit) }}" method="post">
        @csrf
