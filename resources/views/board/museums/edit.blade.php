@extends('layouts.board', ['page_title' => $museum->title])
...
@section('content')
    ...
    <section>
        <form action="{{ route('board.museums.update', $museum) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
                            ...
                            <fieldset slot="{{ $lang }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                            ...
                                            id="contacts"
                                            class="editor"
                                    >{{ old('contacts.'.$lang) ?? $museum->translate('contacts', $lang) }}</textarea>
                                </div>
                            </fieldset>
                        @endforeach
                    </block-editor>
